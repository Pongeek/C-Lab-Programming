...
/*
symmetrical difference function the user an option to perfom a mathematical operation
 of sets of elements which are in either of the sets, but not in their intersection.
 A third set will be inserted with the result.
 (A \ B) U (B \ A)
	parameters:
				set1 - pointer to set argument 1.
